...
public final class MicaAndPTFEInfo extends CapacitorInfo{
    ...
    /**
     * Constructor used for initialization of mica object
     */
    ...
    /**
     * Constructor used for importing mica object
     * @param leadSpacing
     * @param features
     * @param capacitance
     * @param tolerance
     ...
     * @throws Exception 
     */
    public MicaAndPTFEInfo(String leadSpacing, String features, double capacitance, double tolerance, double voltageRating, double operationTemp, String size, String dielectricMat, CapacitorMountingType mount, String packageCase, String seatedHeight, String itemId, String name, String description, String mfg, String mfgPartNum, String series, int qty, double price) throws Exception {
    ...
    /**
     * Import for CSV formatted mica objects
     * @param input
     * @return
     * @throws Exception 
     */
    ...
    /**
     * Importing XML formatting mica objects
     * @param input
     * @return
     * @throws Exception 
     */
